...
import com.visualsharp.uberclone.Model.DriverInfoModel
            ...
            .addListenerForSingleValueEvent(object:ValueEventListener{
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    if(dataSnapshot.exists()){
                        Toast.makeText(this@SplashScreenActivity, "User already Exist!", Toast.LENGTH_SHORT).show()
                    }
                    else {
                        showRegisterLayout()
                    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == LOGIN_REQUEST_CODE)
            if(resultCode == Activity.RESULT_OK) {
                ...
                else Toast.makeText(this, ""+response!!.error!!.message, Toast.LENGTH_SHORT).show()
